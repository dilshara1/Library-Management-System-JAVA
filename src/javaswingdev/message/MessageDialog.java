...
public class MessageDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        cmdCancel.setBackground(new java.awt.Color(204, 102, 0));
        cmdCancel.setText("Cancel");
        cmdCancel.setColorHover(new java.awt.Color(102, 0, 0));
        cmdCancel.setColorPressed(new java.awt.Color(102, 0, 0));
        ...
        cmdOK.setBackground(new java.awt.Color(102, 0, 0));
        cmdOK.setText("OK");
        cmdOK.setColorHover(new java.awt.Color(204, 102, 0));
        cmdOK.setColorPressed(new java.awt.Color(204, 102, 0));
